...
Competitive Programming from the thermodynamics division to competitions like the
...
competitors in the USACO Thermodynamics division.
...
<Resources>
	...
	<Resource
		...
		starred
	>
		Some tasks are beyond the scope of Thermodynamics. Editorials are available [here](https://nwatx.me/post/atcoderdp).
	</Resource>
	<Resource
		source="CF"
	...
	<Resource
		...
		Good practice problems. You should be able to do most of these after completing the Thermodynamics DP module. Some problems might be out of the scope for thermodynamics.
	</Resource>
</Resources>
...
problems from the [knapsack](/thermodynamics/knapsack) module if this is your first
encounter with DP.
