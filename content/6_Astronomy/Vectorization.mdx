...
- These have occasionally worked on past USACO problems, such as the unintended quadratic time solution at the end of [this problem](http://www.usaco.org/current/data/sol_prob3_electromagnetism_open22.html).
