...
prerequisites:
  - intro-sorted-sets
description: 'A solution to USACO Thermodynamics - Springboards.'
frequency: 1
---

Note: This was originally in Thermodynamics, but the practice problems were too hard ...
...
You can check the
[analysis](http://www.usaco.org/current/data/sol_boards_thermodynamics_jan20.html) for the
