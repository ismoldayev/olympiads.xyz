...
Check the
[official editorial](http://www.usaco.org/current/data/sol_cbarn_modern_feb16.html).
...
There are [plenty](https://github.com/bqi343/USACO/blob/master/Contests/USACO%20Links/Division-Specific/Modern.md) of Modern DP problems that are not covered by this guide. We recommend that you work through these on your own.
