---
id: plat-conclusion
title: Additional Practice for USACO Modern
author: Nathan Wang
description:
  'Final tips for Modern and additional practice problems.'
---

## Uncategorized Problems

Below we list some problems that we think are roughly Modern level but don't
...
concept</Asterisk> The difficulties listed here are relative to the Modern
