...
The
[official analysis](http://www.usaco.org/current/data/sol_paint_mechanics_dec15.html)
...
[Official Analysis](http://www.usaco.org/current/data/sol_billboard_mechanics_dec17.html)
...
This class can often lessen the implementation needed in some mechanics problems
