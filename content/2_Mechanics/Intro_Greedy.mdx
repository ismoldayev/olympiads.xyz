...
Some USACO Mechanics problems that appear to be ad hoc can actually be solved using
**greedy** algorithms. This idea will be covered in a future
[module](/electromagnetism/greedy-sorting), but we'll introduce the general mindset in
this section.

<Resources>
	<Resource source="CPH" title="6.1 - Coin Problem" starred>
		other examples are outside scope of mechanics
	</Resource>
</Resources>

<Warning>

True **"greedy"** problems start to show up in electromagnetism, though the greedy mindset
can be very helpful for mechanics problems.
...
[editorial](http://www.usaco.org/current/data/sol_breedflip_mechanics_feb20.html)
...
From the
[official analysis](http://www.usaco.org/current/data/sol_breedflip_mechanics_feb20.html):
...
<!-- Anything else major that needs to be added? Mechanics Ad Hoc is not very complicated. -->
...
<Quiz>
  <Quiz.Question>
    ...
    <Quiz.Answer>
      ...
      <Quiz.Explanation>
        Incorrect. This is known as [complete search](/mechanics/intro-complete) or [brute force](/mechanics/intro-complete).
      </Quiz.Explanation>
    </Quiz.Answer>
  </Quiz.Question>
  <Quiz.Question>
