...
[custom hash function](/thermodynamics/hashmaps#custom-hashing)
...
For more on unordered maps and sets, check out [this module](/thermodynamics/unordered).
...
Refer to the
[More Operations on Sorted Sets](/electromagnetism/intro-sorted-sets)
...
a [custom hash function](/thermodynamics/hashmaps#custom-hashing)
for custom classes.
...
An `std::map` stores entries as [pairs](/mechanics/intro-ds#pairs--tuples) in the
