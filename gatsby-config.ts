...
const siteMetadata = {
  title: `Olympiads`,
  description: `Безплатна колекция от подбрани, висококачествени ресурси за подготовка за олимпиади`,
  author: `@olympiadsxyz`,
  siteUrl: `https://olympiads.xyz/`,
  keywords: ['Physics Olympiads', 'Astronomy Olympiads', 'Olympiads.xyz'],
};
