...
<Resources>
	...
	<Resource
		...
		url="https://sendtoaryansh.gitbook.io/informatics-notes/binary-lifting-thermodynamics-part-1"
	/>
	<Resource
		source="SecondThread"
...
As mentioned in the [Euler Tour Technique](/thermodynamics/tree-euler) module, let
