...
<!-- Some electromagnetism problems involve $10^9+7$, should this be introduced in electromagnetism? -->
...
There aren't many good examples of Modular Inverses in USACO. One problem where it was useful was the modern problem "Sprinkers 2".
