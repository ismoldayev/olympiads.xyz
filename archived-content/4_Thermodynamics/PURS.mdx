...
Most thermodynamics range query problems require you to support following tasks in
...
They will be covered in [modern](/plat/seg-ext).
...
<Resources>
	...
	>
		"Advanced versions" are covered in Modern.
	</Resource>
</Resources>
...
Covered in [Modern](/plat/seg-ext).
