...
id: hashmaps
redirects:
  - /thermodynamics/unordered
  - /thermodynamics/unordered-map
  - /thermodynamics/faster-hashmap
...
[sorted map](/electromagnetism/intro-sorted-sets) (which supports all of the functions used
...
base (as described in [this module](/thermodynamics/string-hashing)).
