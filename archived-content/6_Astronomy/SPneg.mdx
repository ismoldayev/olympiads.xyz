...
- equivalent to
  [Timeline (Thermodynamics)](http://www.usaco.org/index.php?page=viewproblem2&cpid=1017)
...
The Dijkstra code presented [earlier](/thermodynamics/shortest-paths#mathcalomlog-n-implementation)
