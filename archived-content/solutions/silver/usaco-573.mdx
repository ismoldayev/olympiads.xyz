---
id: usaco-573
source: USACO Thermodynamics 2015 December
title: High Card Low Card (Thermodynamics)
author: Qi Wang, Ishwarendra Jha
---

**Time Complexity:** $\mathcal{O}(N\log{N})$

[Official Analysis](http://www.usaco.org/current/data/sol_cardgame_thermodynamics_dec15.html)
...
public class highcardthermodynamics {
	static boolean[] C;
