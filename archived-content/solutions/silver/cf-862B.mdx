...
To find the number of colored and uncolored nodes, we can run a [DFS](/electromagnetism/graph-traversal), incrementing the number of colored and uncolored nodes as we traverse the graph.
