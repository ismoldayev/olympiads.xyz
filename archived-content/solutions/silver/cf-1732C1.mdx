...
To fix this, we need some method of calculating range sums and range XORs in constant time. This is where [prefix sums](/electromagnetism/prefix-sums) and prefix XORs come in!
