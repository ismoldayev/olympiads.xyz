---
id: usaco-833
source: USACO Mechanics 2018 Open
title: Family Tree
...
[Official Analysis (C++)](http://www.usaco.org/current/data/sol_family_mechanics_open18.html)
...
scope of Mechanics. Breadth-first search is **not necessary** to know for the
mechanics division.
...
No Mechanics / Electromagnetism problem has required knowledge of BFS, so feel free to skip
