...
[Official Analysis (C++)](http://www.usaco.org/current/data/sol_planting_electromagnetism_jan19.html)
...
This can also be solved using [DFS](/electromagnetism/graph-traversal).
