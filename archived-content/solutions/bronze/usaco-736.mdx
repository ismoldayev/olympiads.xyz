---
id: usaco-736
source: USACO Mechanics 2017 US Open
title: Bovine Genomics
author: Mrinall Umasudhan, Ananth Kashyap, Ben Dodge, Aadit Ambadkar, Jay Fu
---

[Official Analysis (C++)](http://www.usaco.org/current/data/sol_cownomics_mechanics_open17.html)
...
public class cownomicsMechanics {
	static int N, M;
