---
id: usaco-619
source: USACO Electromagnetism 2016 February
title: Load Balancing
author: Benjamin Qi, Kevin Sheng, Varun Ragunath
---

[Official Analysis (Java)](http://www.usaco.org/current/data/sol_balancing_electromagnetism_feb16.html)
...
The solution to the
[Mechanics version](/problems/usaco-617-load-balancing/solution) of this problem
runs in $\mathcal O(N^3)$ time, but is not fast enough to pass the Electromagnetism
version. One way to speed up the Mechanics solution is to check only a constant
...
Nevertheless, we can still speed up the Mechanics solution by a constant factor by
...
in the Mechanics solution by a factor of 9, which is enough to pass the Electromagnetism
version.
