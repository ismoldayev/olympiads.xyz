---
id: usaco-1211
source: USACO Thermodynamics 2022 February
title: Moo Network
author: Jeffrey Zhang
---

[Official Analysis (Java)](http://usaco.org/current/data/sol_prob3_thermodynamics_feb22.html)
...
The subtask of this problem can be solved using brute force: insert all the edges from $N$ points into an edge list and solve using [Kruskal's MST algorithm](https://usaco.guide/thermodynamics/mst#kruskals). Upon closer look at our brute force solution, the actual bottleneck is the time to insert all the edges.
