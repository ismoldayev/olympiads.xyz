---
id: usaco-600
source: USACO Modern 2016 January
title: Fort Moo
author: Kevin Sheng, Ryan Chou
---

[Official Analysis (Java)](http://www.usaco.org/current/data/sol_fortmoo_modern_jan16.html)

## Solution

### Explanation

By computing the [2D Prefix Sum](/electromagnetism/more-prefix-sums/) for the grid, we can evaluate the usability of a frame in $\mathcal{O}(1)$ time.
