...
However, the optimal solution might involve going from one side to another as well. To account for this, let's use [range DP](/thermodynamics/dp-ranges).
