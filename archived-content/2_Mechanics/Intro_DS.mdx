...
One can solve all Mechanics problems without using anything from this module aside
from arrays. The rest of this module isn't strictly necessary for Mechanics
...
essentially every Mechanics problem, but dynamic arrays, pairs, and tuples can
