...
In Mechanics, we avoided discussion of any set operations involving iterators.
...
structure called an [order statistic tree](/thermodynamics/PURS#order-statistic-tree).
...
to appear on a USACO Electromagnetism contest.
