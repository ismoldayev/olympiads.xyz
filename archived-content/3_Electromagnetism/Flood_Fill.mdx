...
[DFS](/electromagnetism/graph-traversal). The algorithm to
...
A non-recursive implementation of flood fill adds adjacent nodes to a stack or queue, similar to [BFS](/electromagnetism/graph-traversal), and is usually implemented as follows:
