...
- As of the 2022-23 season, USACO staff usually ensure that it is possible to
  receive full credit with all of C++, Python, and Java on Mechanics and Electromagnetism
  problems. However, this is not guaranteed.
- Python is too slow for most Thermodynamics and Modern problems.
...
### Example - [Wormhole Sort](http://www.usaco.org/index.php?page=viewproblem2&cpid=992) (USACO Electromagnetism Jan 2020)
...
Finally, the approach below uses DSU (a Thermodynamics topic), which takes around 1s to
run:
...
continuing onto the Mechanics section of this guide. For a more detailed list on
