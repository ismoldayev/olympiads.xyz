---
id: usaco-940
source: USACO Mechanics 2019 Open
title: Milk Factory
...
[Official Analysis (C++)](http://www.usaco.org/current/data/sol_factory_mechanics_open19.html)
...
This problem can also be solved using [DFS](/electromagnetism/dfs) (a Electromagnetism topic).
