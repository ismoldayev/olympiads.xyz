---
id: usaco-623
source: USACO Thermodynamics 2016 February
title: Fenced In
author: Jeffrey Zhang, Ryan Chou
---

[Official Analysis (C++)](http://www.usaco.org/current/data/sol_fencedin_thermodynamics_feb16.html)
...
To ensure the edges picked are optimal, we construct a minimum spanning tree, which can be solved with [Kruskal's MST algorithm](/thermodynamics/mst#kruskals).
