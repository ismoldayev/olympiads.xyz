...
[Official Analysis](http://www.usaco.org/current/data/sol_sleepy_thermodynamics_jan19.html)
...
public class Sleepy {
	public static void main(String[] args) throws IOException {
		 ...
		 *
		 * Read the analysis of the mechanics version of this problem to learn why
		 * this is the case:
		 * http://www.usaco.org/current/data/sol_sleepy_mechanics_jan19.html
		 */
