---
id: usaco-973
source: USACO Modern 2016 December
title: Bessie's Snow Cow
author: Kevin Sheng
---

[Official Analysis (C++)](http://usaco.org/current/data/sol_snowcow_modern_dec19.html)
...
[lower key and upper key functions](/electromagnetism/intro-sorted-sets#sorted-maps) to efficiently
