---
id: usaco-693
source: USACO Thermodynamics 2017 January
title: Balanced Photo
author: Andy Wang
---

[Official Analysis](http://usaco.org/current/data/sol_bphoto_thermodynamics_jan17.html)

The official solution uses a
[binary indexed tree](/thermodynamics/PURS/#binary-indexed-tree).
...
We can use [order statistic trees](/thermodynamics/PURS/#order-statistic-tree) to achieve
