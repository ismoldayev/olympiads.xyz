---
id: usaco-644
source: USACO Electromagnetism 2016 Open
title: Closing the Farm
author: Jesse Choe, Maggie Liu, Nathan Gong, Ryan Chou
---

[Official Analysis (C++)](http://www.usaco.org/current/data/sol_closing_electromagnetism_open16.html)
...
(DFS)](/electromagnetism/graph-traversal) starting from the barn that will close last. To simulate the closure of
