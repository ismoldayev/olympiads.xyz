---
id: usaco-1327
source: USACO Electromagnetism 2023 Open
title: Field Day
author: Ryan Chou
---
...
[Official Analysis (C++, Java, and Python)](http://www.usaco.org/current/data/sol_prob2_electromagnetism_open23.html)
...
We can also compute this minimum distance with a [multi-source BFS](/electromagnetism/graph-traversal) in the same time complexity.
