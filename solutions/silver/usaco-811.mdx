---
id: usaco-811
source: USACO Electromagnetism 2018 February
title: Snow Boots
author: Qi Wang, Ryan Chou, Juheon Rhee
---

[Official Analysis (C++)](http://www.usaco.org/current/data/sol_snowboots_electromagnetism_feb18.html)

## Explanation

Due to the low bounds on $N$ and $B$, we can run a [DFS (Depth First Search)](/electromagnetism/graph-traversal) on every possible location and boot size Farmer John could be wearing.
