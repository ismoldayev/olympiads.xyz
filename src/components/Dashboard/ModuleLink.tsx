...
function time_ago(time) {
  ...
  const time_formats = [
    [60, 'секунди', 1], // 60
    [120, 'преди 1 минута', 'след 1 минута'], // 60*2
    [3600, 'минути', 60], // 60*60, 60
    [7200, 'преди 1 час', 'след 1 час'], // 60*60*2
    [86400, 'часа', 3600], // 60*60*24, 60*60
    [172800, 'вчера', 'утре'], // 60*60*24*2
    [604800, 'дена', 86400], // 60*60*24*7, 60*60*24
    [1209600, 'миналата седмица', 'следващата седмица'], // 60*60*24*7*4*2
    [2419200, 'седмици', 604800], // 60*60*24*7*4, 60*60*24*7
    [4838400, 'миналия месец', 'следващия месец'], // 60*60*24*7*4*2
    [29030400, 'месеца', 2419200], // 60*60*24*7*4*12, 60*60*24*7*4
    [58060800, 'миналата година', 'следващата година'], // 60*60*24*7*4*12*2
    [2903040000, 'години', 29030400], // 60*60*24*7*4*12*100, 60*60*24*7*4*12
    [5806080000, 'миналия век', 'следващия век'], // 60*60*24*7*4*12*100*2
    [58060800000, 'века', 2903040000], // 60*60*24*7*4*12*100*20, 60*60*24*7*4*12*100
  ];
...
function timeAgoString(time): string {
  ...
  return res && `Последно обновен ${res}`;
}
